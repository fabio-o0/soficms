...
export interface ApiAboutTextAboutText extends Struct.SingleTypeSchema {
  collectionName: 'about_texts';
  info: {
    description: '';
    displayName: 'About';
    pluralName: 'about-texts';
    singularName: 'about-text';
  };
  options: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-text.about-text': ApiAboutTextAboutText;
      'api::cv.cv': ApiCvCv;
